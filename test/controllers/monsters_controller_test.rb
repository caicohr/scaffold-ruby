...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post monsters_url, params: { monster: { detail: @monster.detail, rarity: @monster.rarity, title: @monster.title } }
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { detail: @monster.detail, rarity: @monster.rarity, title: @monster.title } }
